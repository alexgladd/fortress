...
class Char {
  /// The empty character (represented by a space) using the default background
  /// color [Color.black]
  ...
  /// Creates a new [Char] for the given [charOrCharCode] (which must be an
  /// [int] or non-empty [String]) using the optional [foreground] and
  /// [background] [Color]s.
  ...
  @override
  int get hashCode =>
      charCode.hashCode ^ foreground.hashCode ^ background.hashCode;
